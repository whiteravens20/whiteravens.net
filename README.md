...
Home page copy lives in **[`src/content/copy.yml`](src/content/copy.yml)**; the privacy policy and terms of use are Markdown in **[`src/content/privacy.md`](src/content/privacy.md)** and **[`src/content/terms.md`](src/content/terms.md)**, with White Ravens Publisher's own in [`privacy-youtube.md`](src/content/privacy-youtube.md) and [`terms-youtube.md`](src/content/terms-youtube.md). Layout and styling never need to be touched to change wording.
...
src/
  ...
  content/         copy.yml (all home page copy), privacy.md, terms.md, privacy-youtube.md, terms-youtube.md
  ...
  pages/           index.astro, privacy/ and terms/ (index.astro + youtube.astro each), 404.astro
